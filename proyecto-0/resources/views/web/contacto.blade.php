...
<body>
    ...
    <div class="flex flex-col justify-center items-center h-screen rounded-tr-full first-letter:es-full  bg-opacity-50 bg-blue-900">
  ...
  <img     class="h-96 w-full rounded-t-lg object-cover md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
    src="https://pps.whatsapp.net/v/t61.24694-24/328768676_524271279636024_8574569258804315784_n.jpg?ccb=11-4&oh=01_AdRIfRUIhFjziMD50kDp677yuy5WfsboQYqdA4nElE_Giw&oe=648138E6"
    alt="" />
